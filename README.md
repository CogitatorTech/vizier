...
The hosted repository currently includes binaries for DuckDB `v1.2.0` to `v1.5.3`.
...
Open the [latest release](https://github.com/CogitatorTech/vizier/releases/latest) for release notes and platform-specific downloads (`.gz` on Unix-like systems, `.zip` on Windows):
